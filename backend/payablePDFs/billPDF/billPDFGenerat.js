...
async function generatePDF(doc) {
    try {
        ...
        const pdfDirectory = '../billPDF/PDFs/';
        const pdfPath = path.join(__dirname, pdfDirectory, `${plainDoc.paymentID}.pdf`);
        ...
        const relativePath = path.join(__dirname,pdfDirectory, `${plainDoc.paymentID}.pdf`);
